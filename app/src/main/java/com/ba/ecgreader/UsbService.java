...
public class UsbService extends Service {
    ...
    private static final String ACTION_USB_Empty = "com.android.example.EmptyDevices";
    ...
    static Sync.Syncronization sync = new Sync.Syncronization();
        ...
        public void onReceivedData(byte[] arg0) {
            try {
                ...
                if (mHandler != null) {
                    ...
                    //new Thread(new OneStringTask(data)).start();
                    try {
                        sync.produce(data);
                    } catch (Exception e) {
                    }
//                    list.add(data);
    ...
    private void findSerialPortDevice() {
        ...
        if (!usbDevices.isEmpty()) {
            //Toast.makeText(this,"Not empty..!",Toast.LENGTH_LONG);
